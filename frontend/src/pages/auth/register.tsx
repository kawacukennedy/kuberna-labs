        ...
        >
          ...
          <div className="glass-panel rounded-xl p-8 border border-outline/20 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-xl font-medium text-on-surface mb-6">Create Account</h2>
              ...
              <form onSubmit={handleRegister} className="space-y-5">
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant block">Full Name</label>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant block">Email</label>
                  <div className="relative">
                  ...
                  {password.length > 0 && (
                    <div>
                      <div className="h-1 bg-surface-container rounded-full overflow-hidden">
                        <div className="h-full transition-all" style={{ width: `${strength.score}%`, background: strength.color }} />
                      </div>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold uppercase tracking-widest text-on-surface-variant block">I am a...</label>
                  <div className="relative">
                    <Sparkles className="absolute left-4 top-1/2 -translate-y-1/2 text-outline" size={18} />
                    <select
                      value={role}
                      onChange={(e) => setRole(e.target.value)}
                      className="w-full bg-surface-container-low border-0 rounded-lg py-4 pl-12 pr-4 text-on-surface focus:ring-0 focus:bg-surface-container-lowest focus:shadow-glow transition-all appearance-none cursor-pointer"
                    >
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-primary text-white font-medium py-4 px-6 rounded-lg btn-spring mt-2 shadow-glow flex items-center justify-center gap-2"
                >
                  {isLoading ? (
              ...
              <div className="flex items-center gap-4 my-8">
                ...
                <span className="text-xs font-medium text-outline uppercase tracking-wider">Or sign up with</span>
                <div className="h-px bg-surface-container-high flex-1" />
              </div>
