          ...
          <div className="lg:col-span-3">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                <div className="glass p-8 rounded-3xl hover:border-primary/30 transition-all group cursor-pointer">
                   <div className="p-3 bg-blue-100 text-blue-600 w-fit rounded-2xl mb-6"><Zap size={24} /></div>
                ...
                <div className="glass p-8 rounded-3xl hover:border-primary/30 transition-all group cursor-pointer">
                   <div className="p-3 bg-purple-100 text-purple-600 w-fit rounded-2xl mb-6"><Code size={24} /></div>
             ...
             <section className="prose prose-slate max-w-none text-text-secondary leading-relaxed space-y-6">
                ...
                <div className="space-y-8">
                   ...
                   <div className="flex gap-6">
                      <div className="shrink-0 p-4 bg-surface rounded-2xl h-fit border border-glass-border"><Shield size={28} className="text-emerald-600" /></div>
                      <div>
                   ...
                   <div className="flex gap-6">
                      <div className="shrink-0 p-4 bg-surface rounded-2xl h-fit border border-glass-border"><Layers size={28} className="text-blue-600" /></div>
                      <div>
